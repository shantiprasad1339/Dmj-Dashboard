import {
  ...
  flip,
  offset
} from "./chunk-FULQHV3C.js";
import {
  useForkRef_default
} from "./chunk-VT6MHHCN.js";
import {
  ENTERED,
  ENTERING,
  EXITING,
...
} from "./chunk-ZTND6T4G.js";
import {
  require_jsx_runtime
} from "./chunk-RYDJZEGI.js";
import {
  _assertThisInitialized
} from "./chunk-F4EZM3P5.js";
import {
  require_react_dom
...
var Portal = React26.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React26.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React26.isValidElement(children2)) {
      ...
      return React26.cloneElement(children2, newProps);
    }
...
function useSlider(parameters) {
  ...
  const createHandleHiddenInputChange = (otherHandlers) => (event) => {
    ...
    if (range) {
      if (disableSwap) {
        newValue = clamp2(newValue, values2[index2 - 1] || -Infinity, values2[index2 + 1] || Infinity);
      }
  ...
  return (0, import_jsx_runtime49.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime50.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime49.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime49.jsx)(FocusTrap, {
        ...
        isEnabled: isTopModal,
        open,
        children: React74.cloneElement(children2, childProps)
      })]
    }))
  });
});
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FHUOZYPB.js.map
