import {
  require_prop_types
} from "./chunk-PT5KLXON.js";
import "./chunk-OERZCXIB.js";
import {
  require_react
    ...
    var Ft = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, i2, a2, s2) {
        ...
        for (var c2 = [], d2 = 0; d2 < t3.length; d2++) {
          ...
          var b2, v2 = x2, w2 = void 0, k2 = v2, A2 = this.zeroY, S2 = this.zeroY;
          A2 = this.lineHelpers.determineFirstPrevY({ i: d2, series: t3, prevY: A2, lineYPosition: 0 }).prevY, u2.push(A2), b2 = A2;
          "rangeArea" === n2 && (w2 = S2 = this.lineHelpers.determineFirstPrevY({ i: d2, series: s2, prevY: S2, lineYPosition: 0 }).prevY, p2.push(S2));
          var C2 = { type: n2, series: t3, realIndex: g2, i: d2, x: x2, y: 1, pX: v2, pY: b2, pathsFrom: this._calculatePathsFrom({ type: n2, series: t3, i: d2, realIndex: g2, prevX: k2, prevY: A2, prevY2: S2 }), linePaths: [], areaPaths: [], seriesIndex: a2, lineYPosition: 0, xArrj: f2, yArrj: u2, y2Arrj: p2, seriesRangeEnd: s2 }, L2 = this._iterateOverDataPoints(e(e({}, C2), {}, { iterations: "rangeArea" === n2 ? t3[d2].length - 1 : void 0, isRangeStart: true }));
          if ("rangeArea" === n2) {
            var P2 = this._calculatePathsFrom({ series: s2, i: d2, realIndex: g2, prevX: k2, prevY: S2 }), I2 = this._iterateOverDataPoints(e(e({}, C2), {}, { series: s2, pY: w2, pathsFrom: P2, iterations: s2[d2].length - 1, isRangeStart: false }));
            L2.linePaths[0] = I2.linePath + L2.linePath, L2.pathFromLine = I2.pathFromLine + L2.pathFromLine;
          }
          this._handlePaths({ type: n2, realIndex: g2, i: d2, paths: L2 }), this.elSeries.add(this.elPointsMain), this.elSeries.add(this.elDataLabelsWrap), c2.push(this.elSeries);
        }
        ...
        var e2 = t3.type, i2 = t3.series, a2 = t3.iterations, s2 = t3.realIndex, r2 = t3.i, o2 = t3.x, n2 = t3.y, l2 = t3.pX, h2 = t3.pY, c2 = t3.pathsFrom, d2 = t3.linePaths, g2 = t3.areaPaths, u2 = t3.seriesIndex, p2 = t3.lineYPosition, f2 = t3.xArrj, b2 = t3.yArrj, v2 = t3.y2Arrj, y2 = t3.isRangeStart, w2 = t3.seriesRangeEnd, k2 = this.w, A2 = new m(this.ctx), S2 = this.yRatio, C2 = c2.prevY, L2 = c2.linePath, P2 = c2.areaPath, I2 = c2.pathFromLine, T2 = c2.pathFromArea, M2 = x.isNumber(k2.globals.minYArr[s2]) ? k2.globals.minYArr[s2] : k2.globals.minY;
        a2 || (a2 = k2.globals.dataPoints > 1 ? k2.globals.dataPoints - 1 : k2.globals.dataPoints);
        for (var X2 = n2, z2 = 0; z2 < a2; z2++) {
          var E2 = void 0 === i2[r2][z2 + 1] || null === i2[r2][z2 + 1];
          if (k2.globals.isXNumeric) {
            var Y2 = k2.globals.seriesX[s2][z2 + 1];
            void 0 === k2.globals.seriesX[s2][z2 + 1] && (Y2 = k2.globals.seriesX[s2][a2 - 1]), o2 = (Y2 - k2.globals.minX) / this.xRatio;
          } else
            o2 += this.xDivision;
          if (k2.config.chart.stacked)
            if (r2 > 0 && k2.globals.collapsedSeries.length < k2.config.series.length - 1) {
            ...
            p2 = this.zeroY;
          E2 ? n2 = p2 - M2 / S2[this.yaxisIndex] + 2 * (this.isReversed ? M2 / S2[this.yaxisIndex] : 0) : (n2 = p2 - i2[r2][z2 + 1] / S2[this.yaxisIndex] + 2 * (this.isReversed ? i2[r2][z2 + 1] / S2[this.yaxisIndex] : 0), "rangeArea" === e2 && (X2 = p2 - w2[r2][z2 + 1] / S2[this.yaxisIndex] + 2 * (this.isReversed ? w2[r2][z2 + 1] / S2[this.yaxisIndex] : 0))), f2.push(o2), b2.push(n2), v2.push(X2);
          var F2 = this.lineHelpers.calculatePoints({ series: i2, x: o2, y: n2, realIndex: s2, i: r2, j: z2, prevY: C2 }), R2 = this._createPaths({ type: e2, series: i2, i: r2, realIndex: s2, j: z2, x: o2, y: n2, y2: X2, xArrj: f2, yArrj: b2, y2Arrj: v2, pX: l2, pY: h2, linePath: L2, areaPath: P2, linePaths: d2, areaPaths: g2, seriesIndex: u2, isRangeStart: y2 });
          g2 = R2.areaPaths, d2 = R2.linePaths, l2 = R2.pX, h2 = R2.pY, P2 = R2.areaPath, L2 = R2.linePath, !this.appendPathFrom || "monotoneCubic" === k2.config.stroke.curve && "rangeArea" === e2 || (I2 += A2.line(o2, this.zeroY), T2 += A2.line(o2, this.zeroY)), this.handleNullDataPoints(i2, F2, r2, z2, s2), this._handleMarkersAndLabels({ type: e2, pointsPos: F2, i: r2, j: z2, realIndex: s2, isRangeStart: y2 });
        }
        ...
        if (Array.isArray(w2.config.stroke.curve) && (A2 = Array.isArray(v2) ? w2.config.stroke.curve[v2[a2]] : w2.config.stroke.curve[a2]), ("rangeArea" === e2 && (w2.globals.hasNullValues || w2.config.forecastDataPoints.count > 0) || w2.globals.hasNullValues) && "monotoneCubic" === A2 && (A2 = "straight"), "smooth" === A2) {
          var C2 = 0.35 * (o2 - g2);
          w2.globals.hasNullValues ? (null !== i2[a2][r2] && (null !== i2[a2][r2 + 1] ? (p2 = k2.move(g2, u2) + k2.curve(g2 + C2, u2, o2 - C2, n2, o2 + 1, n2), f2 = k2.move(g2 + 1, u2) + k2.curve(g2 + C2, u2, o2 - C2, n2, o2 + 1, n2) + k2.line(o2, S2) + k2.line(g2, S2) + "z") : (p2 = k2.move(g2, u2), f2 = k2.move(g2, u2) + "z")), x2.push(p2), b2.push(f2)) : (p2 += k2.curve(g2 + C2, u2, o2 - C2, n2, o2, n2), f2 += k2.curve(g2 + C2, u2, o2 - C2, n2, o2, n2)), g2 = o2, u2 = n2, r2 === i2[a2].length - 2 && (f2 += k2.curve(g2, u2, o2, n2, o2, S2) + k2.move(o2, n2) + "z", "rangeArea" === e2 && y2 ? p2 += k2.curve(g2, u2, o2, n2, o2, c2) + k2.move(o2, c2) + "z" : w2.globals.hasNullValues || (x2.push(p2), b2.push(f2)));
        } else if ("monotoneCubic" === A2) {
          if ("rangeArea" === e2 ? l2.length === w2.globals.dataPoints : r2 === i2[a2].length - 2) {
            var L2 = l2.map(function(t4, e3) {
              return [l2[e3], h2[e3]];
            }), P2 = Et(L2);
            if (p2 += zt(P2), f2 += zt(P2), g2 = o2, u2 = n2, "rangeArea" === e2 && y2) {
              ...
              f2 += k2.curve(g2, u2, o2, n2, o2, S2) + k2.move(o2, n2) + "z";
            x2.push(p2), b2.push(f2);
          }
        } else {
          if (null === i2[a2][r2 + 1]) {
            p2 += k2.move(o2, n2);
            var z2 = w2.globals.isXNumeric ? (w2.globals.seriesX[s2][r2] - w2.globals.minX) / this.xRatio : o2 - this.xDivision;
            f2 = f2 + k2.line(z2, S2) + k2.move(o2, n2) + "z";
          }
